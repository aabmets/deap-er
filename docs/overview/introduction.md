...
and columnar GP (including memetic and semantic search helpers and a
private Push policy loop), CMA (boxed, separable, restarting, and
MO-CMA), multi-objective and quality-diversity search,
case-structured selection, co-evolution and island stepping, parallel
evaluation, records and checkpoints, and common benchmarks.
